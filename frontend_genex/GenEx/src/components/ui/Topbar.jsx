        ...
        <div className="top-0 left-0 right-0 z-50 w-screen bg-slate-100/50 dark:bg-slate-900 border-b border-slate-300 dark:border-slate-800 h-16 p-0">
            <div className="p-4 flex items-center justify-between">
                ...
                <div className='flex items-center justify-end space-x-4'>
                    ...
                    <button className="px-4 py-1 bg-slate-500/15 text-slate-500 hover:bg-slate-600 active:scale-95 hover:text-red-50 dark:shadow-slate-950 shadow-slate-400 shadow-sm cursor-pointer  transition">Sign Up</button>
                </div>
            </div>
        </div>
    )
