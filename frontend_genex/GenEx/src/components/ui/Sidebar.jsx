...
export default function Sidebar() {
  ...
  const menu = [
    ...
    { id: "generate", icon: Cpu, label: "Générateur IA" },
    { id: "translate", icon: Languages, label: "Traducteur PDF" },
    { id: "library", icon: FolderOpen, label: "Mes Documents" },
    { id: "students", icon: Users, label: "Mes Étudiants" },
    { id: "settings", icon: Settings, label: "Paramètres" },
  ]

  return (
    <div className="flex h-full w-72 flex-col border-r border-slate-300 bg-slate-100/50 dark:border-slate-800 dark:bg-slate-900 p-2">
