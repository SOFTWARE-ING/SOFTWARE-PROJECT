...
import { API_BASE_URL } from '../api_service/url';

const handleLogout = async () => {
  const token = localStorage.getItem("access_token");

  try {
    await fetch(`${API_BASE_URL}/api/genex/auth/logout`, {
      method: "POST",
      headers: {
            ...
            <div className="p-4 flex items-center justify-between">
                <div className="flex flex-col space-x-4">
                    <div className='flex space-x-2 '>
                        ...
                        <h2 className="text-lg font-bold">GenEx-APP</h2>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-end space-x-4'>
                    ...
                    <button className="px-4 py-1 bg-red-500/10 text-red-500 hover:bg-red-600 active:scale-95 hover:text-red-50 dark:shadow-slate-950 shadow-slate-400 shadow-sm cursor-pointer  transition" onClick={handleLogout}>Log Out</button>
